...
import desktopAppIcon from "../../asset/lander/totem-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://totem.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>totem.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g totem-ai")}>
                <code>
                  npm i -g <strong>totem-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g totem-ai")}>
                <code>
                  bun add -g <strong>totem-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/totem")}>
                <code>
                  brew install <strong>anomalyco/tap/totem</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S totem")}>
                <code>
                  paru -S <strong>totem</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask totem-desktop")}>
                <code>
                  brew install --cask <strong>totem-desktop</strong>
                </code>
                <CopyStatus />
              </button>
