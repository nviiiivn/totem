...
import compareVideo from "../../asset/lander/totem-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/totem-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="totem:auth" content={loggedin() ? "true" : "false"} />
