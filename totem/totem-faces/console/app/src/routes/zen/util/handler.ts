...
import { and, Database, eq, isNull, lt, or, sql } from "@totem-ai/console-core/drizzle/index.js"
import { KeyTable } from "@totem-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@totem-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@totem-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@totem-ai/console-core/util/date.js"
import { Identifier } from "@totem-ai/console-core/identifier.js"
import { Billing } from "@totem-ai/console-core/billing.js"
import { Actor } from "@totem-ai/console-core/actor.js"
import { WorkspaceTable } from "@totem-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@totem-ai/console-core/model.js"
import { Subscription } from "@totem-ai/console-core/subscription.js"
import { BlackData } from "@totem-ai/console-core/black.js"
import { UserTable } from "@totem-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@totem-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@totem-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@totem-ai/console-core/lite.js"
import { Resource } from "@totem-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-totem-session") ?? ""
    const requestId = input.request.headers.get("x-totem-request") ?? ""
    const ocClient = input.request.headers.get("x-totem-client") ?? ""
    const projectId = input.request.headers.get("x-totem-project") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-totem-request")
          headers.delete("x-totem-session")
          headers.delete("x-totem-project")
          headers.delete("x-totem-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://totem.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://totem.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://totem.ai/workspace/${authInfo.workspaceID}/members`
