export const dict = {
  ...
  "dialog.provider.totem.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.totem.tagline": "Modelos optimizados y fiables",
  "dialog.provider.totemGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Totem",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Totem.",
  ...
  "provider.connect.totemZen.line1":
    "Totem Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.totemZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.totemZen.visit.prefix": "Visita ",
  "provider.connect.totemZen.visit.link": "totem.ai/zen",
  "provider.connect.totemZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Totem.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Totem.",
  ...
  "dialog.plugins.empty": "Plugins configurados en totem.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Totem se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Totem ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Totem",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (totem.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Totem no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Totem incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Totem dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Totem",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Totem en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Totem sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Totem.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Totem",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Totem.",
