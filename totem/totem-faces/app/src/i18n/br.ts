export const dict = {
  ...
  "dialog.provider.totem.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.totem.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.totemGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Totem",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Totem.",
  ...
  "provider.connect.totemZen.line1":
    "Totem Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.totemZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.totemZen.visit.prefix": "Visite ",
  "provider.connect.totemZen.visit.link": "totem.ai/zen",
  "provider.connect.totemZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Totem.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Totem.",
  ...
  "dialog.plugins.empty": "Plugins configurados em totem.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Totem este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Totem ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Totem",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (totem.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Totem ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Totem inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Totem dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Totem",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Totem aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Totem segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Totem é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Totem iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Totem.",
