...
export const dict = {
  ...
  "dialog.provider.totem.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.totem.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.totemGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Totem tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Totem'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.totemZen.line1":
    "Totem Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.totemZen.visit.prefix": "",
  "provider.connect.totemZen.visit.link": "totem.ai/zen",
  "provider.connect.totemZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Totem'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Totem'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler totem.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Totem sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Totem'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Totem ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (totem.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Totem henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Totem ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Totem Masaüstü",
  ...
  "settings.desktop.wsl.description": "Totem sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Totem'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Totem'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Totem'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Totem'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Totem başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Totem'un en son sürümünü kullanıyorsunuz.",
