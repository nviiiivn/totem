export const dict = {
  ...
  "dialog.provider.totem.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.totem.tagline": "Reliable optimized models",
  "dialog.provider.totemGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Totem",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Totem.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.totemZen.line1":
    "Totem Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.totemZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.totemZen.visit.prefix": "Visit ",
  "provider.connect.totemZen.visit.link": "totem.ai/zen",
  "provider.connect.totemZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Totem.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Totem.",
  ...
  "dialog.plugins.empty": "Plugins configured in totem.json",
  ...
  "dialog.server.description": "Switch which Totem server this app connects to.",
  ...
  "wsl.onboarding.step.totem": "Totem",
  ...
  "wsl.onboarding.checkingTotem": "Checking Totem...",
  "wsl.onboarding.checkingTotemIn": "Checking Totem in {{distro}}...",
  "wsl.onboarding.updatingTotem": "Updating Totem...",
  "wsl.onboarding.updatingTotemIn": "Updating Totem in {{distro}}...",
  "wsl.onboarding.updateTotemIn": "Update Totem in {{distro}}.",
  "wsl.onboarding.updateTotem": "Update Totem",
  "wsl.onboarding.totemReadyIn": "Totem is ready in {{distro}}.",
  "wsl.onboarding.totemReady": "Totem is ready.",
  "wsl.onboarding.installTotemIn": "Install Totem in {{distro}}.",
  "wsl.onboarding.installTotem": "Install Totem",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Totem.",
  ...
  "toast.update.description": "A new version of Totem ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Totem team",
  ...
  "error.chain.checkConfig": "Check your config (totem.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Totem does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Totem includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Totem Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Totem server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Totem",
  ...
  "settings.general.row.appearance.description": "Customise how Totem looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Totem follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Totem is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Totem launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Totem.",
