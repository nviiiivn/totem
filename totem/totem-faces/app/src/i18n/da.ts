export const dict = {
  ...
  "dialog.provider.totem.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.totem.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.totemGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Totem",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Totem.",
  ...
  "provider.connect.totemZen.line1":
    "Totem Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.totemZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.totemZen.visit.prefix": "Besøg ",
  "provider.connect.totemZen.visit.link": "totem.ai/zen",
  "provider.connect.totemZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Totem.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Totem.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i totem.json",
  ...
  "dialog.server.description": "Skift hvilken Totem-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Totem ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Totem-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (totem.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Totem understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Totem inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Totem-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Totem",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Totem ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Totem følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Totem er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Totem starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Totem.",
