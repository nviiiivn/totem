...
import { ResizeHandle } from "@totem-ai/ui/resize-handle"
...
import { getFilename } from "@totem-ai/core/util/path"
import { Session, type Message } from "@totem-ai/sdk/v2/client"
...
import { toaster } from "@totem-ai/ui/toast"
...
import { retry } from "@totem-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@totem-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://totem.ai/desktop-feedback")}
      renderPanel={() =>
