...
import type { Agent } from "@totem-ai/sdk/v2/client"
...
describe("directoryKey", () => {
  test("normalizes slashes", () => {
    expect(String(directoryKey("C:\\Repos\\sst\\totem"))).toBe("C:/Repos/sst/totem")
    expect(String(directoryKey("C:/Repos/sst/totem"))).toBe("C:/Repos/sst/totem")
  })
