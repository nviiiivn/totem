import type { Config, TotemClient, Path, Project, ProviderAuthResponse, Todo } from "@totem-ai/sdk/v2/client"
...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: TotemClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (scope: ServerScope, directory: string, sdk: TotemClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => TotemClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, TotemClient>()
