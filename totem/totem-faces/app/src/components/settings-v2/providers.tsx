...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "totem", key: "dialog.provider.totem.note" },
  { match: (id: string) => id === "totem-go", key: "dialog.provider.totemGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "totem" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "totem" || item.id === "totem-go"}>
