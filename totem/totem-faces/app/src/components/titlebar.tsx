...
import { Tooltip, TooltipKeybind } from "@totem-ai/ui/tooltip"
import { useTheme } from "@totem-ai/ui/theme/context"
import { IconButtonV2 } from "@totem-ai/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@totem-ai/ui/v2/icon"
import { KeybindV2 } from "@totem-ai/ui/v2/keybind-v2"
import { TooltipV2 } from "@totem-ai/ui/v2/tooltip-v2"
...
import "./titlebar.css"
import { Session } from "@totem-ai/sdk/v2"
import { base64Encode } from "@totem-ai/core/util/encode"
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="totem-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                    <ChannelIndicator />
                  </div>
                </div>
              </div>
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="totem-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="totem-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_TOTEM_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_TOTEM_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
