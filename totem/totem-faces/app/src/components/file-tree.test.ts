...
beforeAll(async () => {
  ...
  mock.module("@totem-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@totem-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@totem-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@totem-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
