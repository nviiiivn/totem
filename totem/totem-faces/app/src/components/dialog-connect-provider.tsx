import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@totem-ai/sdk/v2/client"
...
import { List, type ListRef } from "@totem-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "totem"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.totemZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.totemZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.totemZen.visit.prefix")}
                <Link href="https://totem.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.totemZen.visit.link")}
                </Link>
                {language.t("provider.connect.totemZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
