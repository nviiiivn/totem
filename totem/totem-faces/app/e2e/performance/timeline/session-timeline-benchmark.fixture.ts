...
import { mockTotemServer } from "../../utils/mock-server"
import { expectAppVisible, expectSessionTitle } from "../../utils/waits"
import { expect } from "../benchmark"

const directory = "C:/Totem/TimelineStateRegression"
...
const model = { providerID: "totem", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["totem"],
    default: { providerID: "totem", modelID: "claude-opus-4-6" },
  }
}
