...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "TOTEM.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/totem/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/totem (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/totem/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/totem/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const TOTEM_DB|TOTEM_DB|TOTEM_DEV|Global\\.Path\\.data|data =" in packages/totem/src (115 matches)',
  },
] as const
