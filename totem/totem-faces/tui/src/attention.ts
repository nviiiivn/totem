...
import defaultSoundPath from "@totem-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@totem-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@totem-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@totem-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@totem-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@totem-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "totem"
const DEFAULT_PACK_ID = "totem.default"
