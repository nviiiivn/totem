...
import type { AssistantMessage, FilePart, UserMessage } from "@totem-ai/sdk/v2"
...
import { TOTEM_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useTotemKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.TOTEM_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
