...
const releaseId = process.env.TOTEM_RELEASE
if (!releaseId) throw new Error("TOTEM_RELEASE is required")

const version = process.env.TOTEM_VERSION
if (!version) throw new Error("TOTEM_VERSION is required")
...
const macxTarGz = "totem-desktop-mac-x64.app.tar.gz"
const macaTarGz = "totem-desktop-mac-arm64.app.tar.gz"
