export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Totem",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Totem. ¿Quieres instalarla y reiniciar?",
