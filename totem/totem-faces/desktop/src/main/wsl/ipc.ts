...
export function registerWslIpcHandlers(controller: WslServersController) {
  ...
  ipcMain.handle("wsl-servers-probe-totem", (_event: IpcMainInvokeEvent, name: string) =>
    controller.probeTotem(requireWslIpcString("distro", name)),
  )
  ipcMain.handle("wsl-servers-install-totem", (_event: IpcMainInvokeEvent, name: string) =>
    controller.installTotem(requireWslIpcString("distro", name)),
  )
...
function registerUnavailableWslIpcHandlers() {
  ...
  ipcMain.handle("wsl-servers-probe-totem", unavailable)
  ipcMain.handle("wsl-servers-install-totem", unavailable)
