...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/totem.git")).toEqual({ owner: "sst", repo: "totem" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/totem")).toEqual({ owner: "sst", repo: "totem" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/totem.git")).toEqual({ owner: "sst", repo: "totem" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/totem")).toEqual({ owner: "sst", repo: "totem" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/totem.git")).toEqual({ owner: "sst", repo: "totem" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/totem")).toEqual({ owner: "sst", repo: "totem" })
})
