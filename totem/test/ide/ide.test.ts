...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders TOTEM_CALLER", () => {
    process.env["TOTEM_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode TOTEM_CALLER", () => {
    process.env["TOTEM_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown TOTEM_CALLER", () => {
    process.env["TOTEM_CALLER"] = "unknown"
