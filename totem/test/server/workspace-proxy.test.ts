...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips totem-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-totem-directory"]).toBeUndefined()
      expect(forwarded["x-totem-workspace"]).toBeUndefined()
