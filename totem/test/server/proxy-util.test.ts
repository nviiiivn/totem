...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips totem-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-totem-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-totem-directory")).toBeNull()
      expect(result.get("x-totem-workspace")).toBeNull()
