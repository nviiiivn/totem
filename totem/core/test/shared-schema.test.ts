...
import { Agent } from "@totem-ai/schema/agent"
import { Location } from "@totem-ai/schema/location"
import { Model } from "@totem-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@totem-ai/schema/prompt"
import { Provider } from "@totem-ai/schema/provider"
import { Project } from "@totem-ai/schema/project"
import { Session } from "@totem-ai/schema/session"
import { SessionInput } from "@totem-ai/schema/session-input"
import { SessionMessage } from "@totem-ai/schema/session-message"
import { Workspace } from "@totem-ai/schema/workspace"
import { Command } from "@totem-ai/schema/command"
import { Connection } from "@totem-ai/schema/connection"
import { Credential } from "@totem-ai/schema/credential"
import { FileSystem } from "@totem-ai/schema/filesystem"
import { Integration } from "@totem-ai/schema/integration"
import { LLM } from "@totem-ai/schema/llm"
import { Permission } from "@totem-ai/schema/permission"
import { Reference } from "@totem-ai/schema/reference"
import { Skill } from "@totem-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis } from "@totem-ai/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@totem-ai/core/command"),
    import("@totem-ai/core/integration/connection"),
    import("@totem-ai/core/credential"),
    import("@totem-ai/core/filesystem"),
    import("@totem-ai/core/integration"),
    import("@totem-ai/core/location"),
    import("@totem-ai/llm"),
    import("@totem-ai/core/permission"),
    import("@totem-ai/core/project/schema"),
    import("@totem-ai/core/reference"),
    import("@totem-ai/core/session/input"),
    import("@totem-ai/core/session/message"),
    import("@totem-ai/core/session/prompt"),
    import("@totem-ai/core/skill"),
    import("@totem-ai/core/v2-schema"),
    import("@totem-ai/core/workspace"),
  ])
