...
import type { Data, Definition, Payload } from "@totem-ai/schema/event"
...
import { Durable } from "@totem-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@totem-ai/schema/event").ID
export type { Data, Definition, Payload } from "@totem-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@totem/Event") {}
