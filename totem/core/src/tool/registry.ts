...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@totem-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@totem/v2/ToolRegistry") {}
