...
/** Intentional public native API for Effect applications embedding Totem. */
export class Service extends Context.Service<Service, Interface>()("@totem/public/Totem") {}
...
// TODO: Add Totem.create(...) as the Promise facade over the same native API semantics.
