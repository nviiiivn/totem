...
import type { Plugin } from "@totem-ai/plugin/v2/effect"
import { PluginEvent, PluginID } from "@totem-ai/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@totem/v2/Plugin") {}
