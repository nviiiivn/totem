...
export class Service extends Context.Service<Service, Interface>()("@totem/v2/FileSystem/Search") {}
...
export const locationLayer = Layer.unwrap(
  Effect.sync(() => (Flag.TOTEM_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
