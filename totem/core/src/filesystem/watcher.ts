...
import { FileSystemWatcher } from "@totem-ai/schema/filesystem-watcher"
...
declare const TOTEM_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof TOTEM_LIBC === "undefined" ? undefined : TOTEM_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@totem/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.TOTEM_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.TOTEM_EXPERIMENTAL_FILEWATCHER) {
