...
import { SessionTodo, SessionTodoInfo } from "@totem-ai/schema/session-todo"
...
export class Service extends Context.Service<Service, Interface>()("@totem/v2/SessionTodo") {}
