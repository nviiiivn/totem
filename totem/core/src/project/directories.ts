...
import type { EffectDrizzleSqlite } from "@totem-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@totem/ProjectDirectories") {}
