...
import { ProjectDirectoriesEvent } from "@totem-ai/schema/project-directories"
...
export class Service extends Context.Service<Service, Interface>()("@totem/ProjectCopy") {}
