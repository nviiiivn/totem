...
import { Entry, FileSystem, Match } from "@totem-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@totem-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@totem/v2/FileSystem") {}
