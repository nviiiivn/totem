...
class Database extends Context.Service<Database, DatabaseShape>()("@totem/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@totem/example/UserStore") {
