...
import { httpClient, path } from "@totem-ai/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@totem/SkillDiscovery") {}
