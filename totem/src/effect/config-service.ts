 ...
 *   "@totem/ServerAuthConfig",
 *   {
 *     password: Config.string("TOTEM_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("TOTEM_SERVER_USERNAME").pipe(Config.withDefault("totem")),
 *   },
 * ) {}
 *
