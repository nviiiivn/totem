...
export class Service extends Context.Service<Service, Interface>()("@totem/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __TOTEM_PHOTON_WASM_PATH?: string }).__TOTEM_PHOTON_WASM_PATH =
