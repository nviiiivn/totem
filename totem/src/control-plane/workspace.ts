...
import { EventSequenceTable, EventTable } from "@totem-ai/core/event/sql"
...
import { WorkspaceEvent } from "@totem-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@totem/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        TOTEM_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        TOTEM_WORKSPACE_ID: config.id,
        TOTEM_EXPERIMENTAL_WORKSPACES: "true",
