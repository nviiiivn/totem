...
import { ProjectDirectoryTable, ProjectTable } from "@totem-ai/core/project/sql"
...
import { which } from "@totem-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@totem/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.TOTEM_FAKE_VCS)
