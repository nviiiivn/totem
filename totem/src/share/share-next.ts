...
import type * as SDK from "@totem-ai/sdk/v2"
...
import { SessionShareTable } from "@totem-ai/core/share/sql"
...
const disabled = process.env["TOTEM_DISABLE_SHARE"] === "true" || process.env["TOTEM_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@totem/ShareNext") {}
