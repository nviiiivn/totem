...
>()("@totem/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@totem/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.TOTEM_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.TOTEM_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-totem-directory"] || process.cwd()
}
