...
export const StopPayload = Schema.Struct({
...
export const SessionPaths = {
  ...
  enforcement: `${root}/:sessionID/enforcement`,
...
export const SessionApi = HttpApi.make("session")
      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all Totem sessions, sorted by most recently updated.",
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific Totem session.",
          }),
        ),
        ...
        HttpApiEndpoint.get("enforcement", SessionPaths.enforcement, {
          params: { sessionID: SessionID },
          query: WorkspaceRoutingQuery,
          success: described(SessionEnforcement.Info, "Enforcement state"),
          error: [HttpApiError.BadRequest, ApiNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "session.enforcement",
            summary: "Get session enforcement state",
            description:
              "Retrieve the live constitution-enforcement state for a session: whether it is stopped, and any active directives.",
          }),
        ),
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new Totem session for interacting with AI assistants and managing conversations.",
          }),
        ),
        ...
        HttpApiEndpoint.post("stop", SessionPaths.stop, {
          ...
          query: WorkspaceRoutingQuery,
          payload: StopPayload,
          success: described(Schema.Boolean, "Stopped session"),
          error: HttpApiError.BadRequest,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "session.stop",
            summary: "Hard-stop session (carve 3 kill switch)",
            description:
              "Stop the session and block any new work from starting until a human resumes it. Stronger than abort: abort cancels the current turn but lets the next prompt start normally; stop blocks new turns too.",
          }),
        ),
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "totem experimental HttpApi",
      version: "0.0.1",
