import type { JsonSchema, LLMRequest, ProviderMetadata } from "@totem-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@totem-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @totem-ai/llm request objects from totem's session/AI SDK-shaped data.
  return LLM.request({
