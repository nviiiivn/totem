...
import type { AssistantMessage as TotemAssistantMessage, Message } from "@totem-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<TotemAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<TotemAssistantMessage, "role"> &
  Partial<Pick<TotemAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@totem/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@totem/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@totem/ACPUsage") {}
