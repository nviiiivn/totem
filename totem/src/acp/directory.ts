...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@totem/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@totem/ACPDirectory") {}
