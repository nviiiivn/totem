...
import { openEditor } from "@totem-ai/tui/editor"
import { registerTotemKeymap } from "@totem-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerTotemKeymap(keymap, renderer, input.tuiConfig)
