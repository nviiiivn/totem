...
import { normalizePromptContent } from "@totem-ai/tui/editor"
...
import { TOTEM_BASE_MODE, useBindings } from "@totem-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Totem" } satisfies SlashOption,
    ]
