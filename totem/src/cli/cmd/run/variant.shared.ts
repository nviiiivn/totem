...
//
// The saved variant persists across sessions in ~/.local/state/totem/model.json
...
class Service extends Context.Service<Service, VariantService>()("@totem/RunVariant") {}
