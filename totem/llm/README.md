...
Schema-first LLM core for totem. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@totem-ai/llm"
import { OpenAI } from "@totem-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@totem-ai/llm/providers"
