...
> current private `@totem-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@totem-ai/ai`
...
- Secondary audience: Totem and other durable agent runtimes
...
import { LLM } from "@totem-ai/ai"
import { OpenAI } from "@totem-ai/ai/providers/openai"
...
```ts
import { Message } from "@totem-ai/ai"
...
import { LLM, Tool } from "@totem-ai/ai"
...
Totem and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@totem-ai/ai/promise"
import { OpenAI } from "@totem-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@totem-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@totem-ai/ai/provider"
...
@totem-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@totem-ai/ai/providers/openai
@totem-ai/ai/providers/anthropic
@totem-ai/ai/providers/google
...
```
...
Totem should migrate to `generateTurn` / `streamTurn`, preserving its durable
