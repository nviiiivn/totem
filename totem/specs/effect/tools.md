...
Practical reference for the current tool-migration state in `packages/totem`.
...
Tool tests should use the existing Effect helpers in `packages/totem/test/lib/effect.ts`:
