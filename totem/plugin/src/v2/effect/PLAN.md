...
- Effect plugins import `@totem-ai/plugin/v2/effect`, not `@totem-ai/core`.
- Public domain values use generated `@totem-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@totem-ai/plugin/v2/effect`.
