...
export const TypeId: TypeId = "~@totem-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@totem-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@totem-ai/effect-sqlite-node/NodeSqliteClient")
