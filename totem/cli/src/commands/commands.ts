...
declare const TOTEM_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof TOTEM_CLI_NAME === "string" ? TOTEM_CLI_NAME : "totem", {
  description: "Totem 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
