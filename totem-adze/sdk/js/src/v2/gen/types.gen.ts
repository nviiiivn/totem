...
export type EnforcementDirective = {
  subject: string
  reason?: string
}
...
export type EnforcementState = {
  stopped: boolean
  stopReason?: string
  directives: Array<EnforcementDirective>
}
...
/**
 * Server configuration for totem serve and web commands
 */
...
export type V2EventEnforcementUpdated = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type EventEnforcementUpdated = {
  id: string
  type: "enforcement.updated"
  properties: {
    sessionID: string
...
export type SessionEnforcementData = {
  body?: never
  path: {
    sessionID: string
  }
...
export type SessionEnforcementErrors = {
  /**
   * BadRequest | InvalidRequestError
   */
  400: EffectHttpApiErrorBadRequest | InvalidRequestError
...
export type SessionEnforcementError = SessionEnforcementErrors[keyof SessionEnforcementErrors]

export type SessionEnforcementResponses = {
  /**
   * Enforcement state
   */
  200: EnforcementState
}

export type SessionEnforcementResponse = SessionEnforcementResponses[keyof SessionEnforcementResponses]
