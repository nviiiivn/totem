...
import type {
  ...
  SessionEnforcementErrors,
  SessionEnforcementResponses,
  SessionForkErrors,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new TotemClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Totem system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Totem system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Totem server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Totem state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Totem configuration settings and preferences.
   */
   ...
   *
   * Update global Totem configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Totem server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Totem system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Totem instances, releasing all resources.
   */
   ...
   * Upgrade totem
   *
   * Upgrade totem to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Totem configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Totem configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Totem instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Totem system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Totem.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Totem is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Totem.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Totem sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Totem session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Totem session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
  ...
  public enforcement<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<SessionEnforcementResponses, SessionEnforcementErrors, ThrowOnError>({
      url: "/session/{sessionID}/enforcement",
      ...options,
      ...params,
    })
  }
  ...
  /**
   * Hard-stop session (carve 3 kill switch)
   *
...
export class TotemClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<TotemClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    TotemClient.__registry.set(this, args?.key)
  }
