...
Generates UPCOMING_CHANGELOG.md by running the totem changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for totem run (default: low)
      --quiet            Suppress totem command output unless it fails
