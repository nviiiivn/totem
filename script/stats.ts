...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/totem/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/totem...\n")
...
console.log("Fetching npm all-time downloads for totem-ai...\n")
const npmDownloads = await fetchNpmDownloads("totem-ai")
