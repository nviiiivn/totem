...
- Source: github.com/supermemoryai/opencode-supermemory
- Type: Plugin (npm)
...
- Integration: Add "opencode-supermemory" to plugin array in totem.json. Auth via SUPERMEMORY_API_KEY or browser login. Supports self-hosted baseUrl.
...
### 2. opencode-pty
- Source: github.com/shekohex/opencode-pty
- Type: Plugin (npm)
...
- Integration: Add "opencode-pty" to plugin array.
...
- Source: github.com/Opencode-DCP/opencode-dynamic-context-pruning
- Type: Plugin (npm: @tarquinen/opencode-dcp)
...
- Source: github.com/ghoulr/opencode-websearch-cited
- Type: Plugin (npm)
...
- Why MUST: Enables multi-agent cooperation patterns needed for oh-my-opencode-slim's Pantheon architecture.
...
### 15. opencode-notify (kdcokenny)
- Source: github.com/kdcokenny/opencode-notify
...
### 16. opencode-worktree (kdcokenny)
- Source: github.com/kdcokenny/opencode-worktree
...
- Integration: ocx add kdco/worktree. Config via .opencode/worktree.jsonc.
...
### 19. oh-my-opencode-slim (alvinunreal)
- Source: github.com/alvinunreal/oh-my-opencode-slim
...
- Why STRONG: Most complete opencode orchestration suite. Nearly everything portable since totem is an opencode fork. The orchestrator pattern with background subagent scheduling and multi-LLM council is exactly what oh-my-totempole should be.
...
### 26. daytona opencode-plugin
- Source: github.com/daytonaio/daytona/tree/main/libs/opencode-plugin
- Type: Plugin
- What: Daytona integration for opencode. Daytona provides sandboxed dev environments in the cloud.
...
### 27. opencode-log-sanitizer (from awesome-opencode list)
- Source: github.com/errhythm/opencode-log-sanitizer
- Type: Plugin
...
### 28. CC Safety Net (from awesome-opencode list)
...
### 30. Workaholic (from awesome-opencode list)
- Source: awesome-opencode entry
- Type: Plugin
...
### 31. BRHP (from awesome-opencode list)
...
### 32. Steering (from awesome-opencode list)
- Source: awesome-opencode entry
- Type: Plugin
...
### 33. open-plan-annotator (from awesome-opencode list)
...
### 34. agent-dotfiles (from awesome-opencode list)
- Source: github.com/saqibameen/agent-dotfiles
- Type: Tool
- What: Write AI coding rules once, sync to every agent (Claude Code, Cursor, Codex, OpenCode).
...
### 35. opencode-wakatime (angristan)
- Source: github.com/angristan/opencode-wakatime
- Type: Plugin (npm)
...
### 36. opencode-antigravity-auth (NoeFabris)
...
### 37. opencode-agent-skills (joshuadavidthomas)
- Source: github.com/joshuadavidthomas/opencode-agent-skills
...
### 48. awesome-opencode
- Source: github.com/awesome-opencode/awesome-opencode
- Type: Curated list (8.6k stars, 150+ plugins)
- What: The canonical opencode ecosystem list. Already mined for items above.
...
- opencode-dynamic-context-pruning (model-driven context compression)
- envsitter-guard (.env file protection)
- opencode-websearch-cited (cited web search)
- ControlFlowMonitor (flow/state enforcement)
- opencode-notify (OS notifications)
- opencode-worktree (parallel worktree sessions)
- opencode-log-sanitizer (secret redaction)
...
- oh-my-opencode-slim -> oh-my-totempole (the orchestration core)
...
- awesome-opencode, Awesome-AI-Agents, awesome-ai-plugins
...
### SKIP/DEFER
- opencode-wakatime (metrics only, no agent benefit)
- opencode-antigravity-auth (TOS violation risk)
- opencode-agent-skills (totem native skill support covers this)
...
2. Security: envsitter-guard, CC Safety Net, opencode-log-sanitizer (immediate protection)
3. Memory: opencode-supermemory (cross-session memory)
4. Context: opencode-dynamic-context-pruning (context management)
5. Flow: ControlFlowMonitor (Rule 20/21 enforcement)
6. Background ops: opencode-pty (dev servers, REPLs)
7. Research: opencode-websearch-cited, verify context7 (Rule 2 satisfaction)
8. Workflow: opencode-notify, opencode-worktree (QoL for parallel work)
9. Completeness: Workaholic (Rule 3 enforcement)
10. MCP servers: Sentry, Notion, Atlassian, Shadcn (as needed)
11. Core: Fork oh-my-opencode-slim -> oh-my-totempole (orchestration suite)
...
4. opencode-antigravity-auth: skip due to TOS risk, or accept the risk for free Claude/Gemini quota?
5. awesome-claude-code-subagents: which of the 154 agents do you actually want? All 11 priority picks, or narrower selection?
6. oh-my-opencode-slim fork: full port (all 8 agents + 8 skills + tools + hooks), or selective port of only orchestrator + council + key agents?
