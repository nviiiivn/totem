import totemWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/totem",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star Totem on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "totem:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://totem.ai/">
            <strong>Try Totem</strong>
          </a>
          <button
...
function TotemMark() {
  return (
    <svg data-slot="totem-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://totem.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://totem.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@totem.ai", label: "Contact us" },
    { href: "https://totem.ai/discord", label: "Community" },
    { href: "https://x.com/totem", label: "X" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://totem.ai" aria-label="Totem home">
          <TotemMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={totemWordmarkDark} alt="Totem" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">Totem Newsletter</h2>
            <p>
