...
Erstellen Sie `.totem/commands/test.md`:

```md title=".totem/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Totem-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Totem [config](/docs/config):

```json title="totem.jsonc" {4-12}
{
...
- Global: `~/.config/totem/commands/`
- Pro Projekt: `.totem/commands/`

```markdown title="~/.config/totem/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".totem/commands/component.md"
---
...
```md title=".totem/commands/create-file.md"
---
...
```md title=".totem/commands/analyze-coverage.md"
---
...
```md title=".totem/commands/review-changes.md"
---
...
```md title=".totem/commands/review-component.md"
---
...
Totem enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
