---
title: Teilen
description: Teile Totem-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Totem-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Totem Folgendes:
...
Totem hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Totem den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`totem.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du totem in deiner Organisation einsetzt.
