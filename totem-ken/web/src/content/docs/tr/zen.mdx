---
title: Zen
description: totem tarafından sağlanan seçilmiş modeller listesi.
---
...
Totem Zen, Totem ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Totem'daki diğer sağlayıcılar gibi çalışır. Totem Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Totem kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Totem ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Totem Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Totem Zen, Totem'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Totem Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Totem Zen'i seçin ve API anahtarınızı yapıştırın.
...
Totem yapılandırmanızdaki [model id](/docs/config/#models) `totem/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `totem/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Totem'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Totem'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Totem'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Totem'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Totem'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Totem Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Totem ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
