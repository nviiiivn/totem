...
`.totem/commands/test.md` oluştur:
...
totem işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

totem [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/totem/commands/`
- Proje başına: `.totem/commands/`
...
totem, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
