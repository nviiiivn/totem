---
title: Paylasim
description: totem konusmalarini genel baglantilarla paylasin.
---

totem'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda totem:
...
totem, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak totem manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `totem.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda totem kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
