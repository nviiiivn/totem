...
description: totem dile özgü biçimlendiriciler kullanır.
---

totem, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

totem, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, totem bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

totem bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri totem yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
