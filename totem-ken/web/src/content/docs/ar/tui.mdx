---
title: TUI
description: استخدام واجهة المستخدم TUI في Totem.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Totem واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Totem إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Totem في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Totem. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Totem. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `totem.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Totem بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `totem.default`.
