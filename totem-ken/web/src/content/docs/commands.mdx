...
You can add custom commands through the Totem config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Totem [config](/docs/config):
...
totem includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
