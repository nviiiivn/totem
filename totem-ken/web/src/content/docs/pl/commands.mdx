...
Możesz zdefiniować polecenia w `totem.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji totem:
...
- Globalnie: `~/.config/totem/commands/`
- Na projekt: `.totem/commands/`
...
totem zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
