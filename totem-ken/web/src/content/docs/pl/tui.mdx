---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala totem.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

totem zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie totem uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI totem, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do totem. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `totem.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Totem czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `totem.default`.
