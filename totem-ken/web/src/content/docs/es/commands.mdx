...
Puede agregar comandos personalizados a través de la configuración Totem o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Totem [config](/docs/config):
...
totem incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
