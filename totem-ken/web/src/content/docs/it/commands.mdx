...
Puoi aggiungere comandi personalizzati tramite la config di Totem o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Totem:
...
- Globale: `~/.config/totem/commands/`
- Per progetto: `.totem/commands/`
...
totem include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
