---
title: LSP-servere
description: totem integreres med LSP-serverne dine.
---

Totem kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Totem kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `TOTEM_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og totem åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Totem-konfigurasjonen.
