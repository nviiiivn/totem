---
title: TUI
description: Bruke totem-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Totem gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Totem starter TUI for gjeldende katalog.
...
Når du bruker Totem TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Totem. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Totem. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `totem.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Totem venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `totem.default`.
