...
Opprett `.totem/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Totem-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Totem [config](/docs/config):
...
Totem inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
