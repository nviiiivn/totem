...
Agentferdigheter lar Totem oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går totem opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
totem viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `totem.json`:
