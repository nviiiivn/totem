---
title: TUI
description: Korištenje korisničkog interfejsa Totem terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Totem pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Totem pokreće TUI za trenutni direktorij.
...
Kada koristite Totem TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Totem. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Totem. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `totem.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Totem čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `totem.default`.
