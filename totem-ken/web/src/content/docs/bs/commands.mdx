...
Kreiraj `.totem/commands/test.md`:
...
Možete dodati prilagođene komande kroz Totem konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Totem [config](/docs/config):
...
- Globalno: `~/.config/totem/commands/`
- Po projektu: `.totem/commands/`
...
Totem uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
