---
title: LSP serveri
description: Totem se integriše sa vašim LSP serverima.
---

Totem se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Totem dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `TOTEM_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i totem otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj totem konfiguraciji.
