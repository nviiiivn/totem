...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Totem:
...
- ระดับผู้ใช้ (Global): `~/.config/totem/commands/`
- ระดับโปรเจ็กต์: `.totem/commands/`
...
Totem มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
