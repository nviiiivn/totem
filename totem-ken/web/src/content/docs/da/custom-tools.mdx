...
description: Opret værktøjer, som LLM kan kalde totem ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med totems [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.totem/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/totem/tools/`.
