...
Du kan tilføje brugerdefinerede kommandoer gennem Totem-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Totem [config](/docs/config):
...
- Globalt: `~/.config/totem/commands/`
- Pr. projekt: `.totem/commands/`
...
totem indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
