---
title: LSP-servere
description: Totem integreres med dine LSP-servere.
---

Totem kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Totem leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `TOTEM_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og totem åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din totem-konfiguration.
