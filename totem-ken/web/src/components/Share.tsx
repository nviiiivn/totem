...
import { IconTotem } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "totem/session/message-v2"
import type { Message } from "totem/session/message"
import type { Session } from "totem/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.totem_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.totem_name}>
                    <IconTotem width={16} height={16} />
                  </div>
