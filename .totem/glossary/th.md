...
- PR #10809: https://github.com/anomalyco/totem/pull/10809
- PR #11496: https://github.com/anomalyco/totem/pull/11496

## Do Not Translate (Locale Additions)

- `Totem` (preserve casing in prose; keep `totem` only in commands, package names, paths, or code)
- `Totem CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
