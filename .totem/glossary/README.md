...
Use this folder for locale-specific translation guidance that supplements `.totem/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/totem/pull/12345

## Do Not Translate (Locale Additions)

- `Totem` (preserve casing)
