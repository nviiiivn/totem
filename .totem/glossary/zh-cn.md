...
- PR #13942: https://github.com/anomalyco/totem/pull/13942

## Do Not Translate (Locale Additions)

- `Totem` (preserve casing in prose; keep `totem` only when it is part of commands, package names, paths, or code)
- `Totem Zen`
- `Totem CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `totem` in prose when referring to the product name; use `Totem`
