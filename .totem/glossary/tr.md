...
- PR #15835: https://github.com/anomalyco/totem/pull/15835

## Do Not Translate (Locale Additions)

- `Totem` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `totem` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Totem` in prose, `totem` only for exact technical identifiers
...
- Avoid changing `totem` to `Totem` inside commands, URLs, package names, or code literals
