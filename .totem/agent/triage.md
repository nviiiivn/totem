...
Desktop application and browser-based app issues, including `totem web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core totem server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Totem Zen, Totem Go, and billing issues.
