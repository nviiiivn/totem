...
Totem automatically formats files after they are written or edited, using language-specific formatters. No manual step needed.

Includes Prettier, Biome, `gofmt`, `rustfmt`, `ruff`, and 20+ others.

> See the [official Totem docs](https://totem.ai/docs/formatters/#built-in) for the complete list.
