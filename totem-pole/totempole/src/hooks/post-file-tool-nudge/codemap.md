...
- **Hook Registration**: Hooks into Totem's `tool.execute.after` lifecycle phase
...
- **Consumed by**: Totem plugin lifecycle hooks (src/index.ts)
- **Depends on**: 
...
- Violate the delegation principle of the Totem architecture
