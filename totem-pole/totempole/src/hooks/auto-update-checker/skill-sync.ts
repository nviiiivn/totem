 ...
 *
 * How to populate:
 * 1. Download previous releases of the npm package: `npm pack totempole@<version>`
...
/**
 * Acquires a simple lock under .totempole.
...
/**
 * Synchronizes bundled skills from the newly installed package root to Totem config skills directory.
 */
export function syncBundledSkillsFromPackage(
  ...
  const manifestDir = path.join(getConfigDir(), '.totempole');
