...
describe('syncBundledSkillsFromPackage', () => {
  ...
  beforeEach(() => {
    ...
    origEnvConfigDir = process.env.TOTEM_CONFIG_DIR;
    ...
    process.env.TOTEM_CONFIG_DIR = fakeDestConfigDir;
  });

  afterEach(() => {
    process.env.TOTEM_CONFIG_DIR = origEnvConfigDir;
  ...
  test('stages update and marks customized if managed skill was modified by user', async () => {
    ...
    const manifestDir = path.join(fakeDestConfigDir, '.totempole');
