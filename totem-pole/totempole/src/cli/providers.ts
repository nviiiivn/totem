...
export const GENERATED_PRESETS = ['openai', 'totem-go'] as const;
...
export const MODEL_MAPPINGS = {
  ...
  'totem-go': {
    ...
    oracle: { model: 'totem-go/qwen3.7-max', variant: 'max' },
    librarian: { model: 'totem-go/deepseek-v4-flash' },
    explorer: { model: 'totem-go/deepseek-v4-flash' },
    designer: { model: 'totem-go/kimi-k2.7-code', variant: 'medium' },
    fixer: { model: 'totem-go/deepseek-v4-flash', variant: 'high' },
