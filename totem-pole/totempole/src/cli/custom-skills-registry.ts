 ...
 * Unlike npx-installed skills, these are copied from src/skills/ to the Totem skills directory
 */
...
export const CUSTOM_SKILLS: CustomSkill[] = [
  ...
  },
  {
    name: 'totempole',
    description:
      'Configure, customize, and safely improve totempole setups',
    allowedAgents: ['orchestrator'],
    sourcePath: 'src/skills/totempole',
  },
  {
