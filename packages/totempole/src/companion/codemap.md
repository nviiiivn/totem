...
- **Producer (manager.ts)**: `CompanionManager` class
  ...
  - Maintains state in a JSON file at `~/.local/share/opencode/storage/totempole/companion-state.json`
...
- Binary path determined by:
  ...
  - Default location: `~/.local/share/opencode/storage/totempole/bin/`
...
- **State file**: `~/.local/share/opencode/storage/totempole/companion-state.json`
- **Binary**: `~/.local/share/opencode/storage/totempole/bin/totempole-companion[.exe]`
- **Metadata**: `~/.local/share/opencode/storage/totempole/bin/totempole-companion.json`
