...
CLI entry point and command-line interface for the totempole plugin. Provides installation, configuration, and diagnostic commands for setting up and managing the OpenCode plugin.
...
### `install` Command
Sets up totempole plugin with OpenCode.
