 ...
 * Project config uses <directory>/.opencode/totempole.
 *
 ...
 * 1. User config: $OPENCODE_CONFIG_DIR/totempole.jsonc or .json,
 *    or ~/.config/opencode/totempole.jsonc or .json (or $XDG_CONFIG_HOME)
 * 2. Project config: <directory>/.opencode/totempole.jsonc or .json
 *
