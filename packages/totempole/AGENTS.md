...
**totempole** - A lightweight agent orchestration plugin for OpenCode, a slimmed-down fork of totempole. Built with TypeScript, Bun, and Biome.
...
### Plugin
~/.local/share/opencode/log/totempole.<timestamp>.log
